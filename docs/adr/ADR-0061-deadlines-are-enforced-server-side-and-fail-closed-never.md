# ADR-0061 — Deadlines are enforced server-side and fail closed, never leaving partial state

| Field | Value |
|---|---|
| **Status** | Accepted |
| **Legacy id** | `ADR-P4U-004` |
...
Deadlines are enforced server-side and fail closed, never leaving partial state

## Rationale

Prevents hung kernel calls and half-applied work
