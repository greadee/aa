# ADR-0045 — The local transport is attach-or-own
...
The local transport is attach-or-own

## Rationale

One journal per session; a second `Ensure` attaches to the existing owner instead of opening a second journal
